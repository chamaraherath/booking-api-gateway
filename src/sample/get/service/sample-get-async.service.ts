 ...
 */
@Injectable()
export class SampleGetAsyncServiceImpl implements IRequestHandler{
    ...
    async index(param: any): Promise<HttpSuccessResponse> {
        try {
          ...
          return Promise.resolve(new HttpSuccessResponse(ResponseMessage.SUCCESS, HttpStatus.ACCEPTED,[]));
